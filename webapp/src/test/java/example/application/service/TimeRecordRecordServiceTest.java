...
class TimeRecordRecordServiceTest {
    ...
    void 登録した勤怠情報を取得できる() {
        ...
        ActualWorkTime actualWorkTime = new ActualWorkTime(new WorkRange(new StartTime(new ClockTime("9:00")), new EndTime(new ClockTime("24:00"))), new DaytimeBreakTime(new Minute(60)), new NightBreakTime(new Minute("0")));
